# Residence time calculations (prelim) for the FLK 

## 10/9/2023 This script will not run on Heidi's computer (use Focal_ResTime (new).R which is adapted for Heidi)
