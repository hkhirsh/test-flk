...
## 11/13/2023 add nutrients to make new input dataframe
rm(list=ls())
...
# BBBn = st_read('/Users/heidi.k.hirsh/Desktop/nutBows_space&time_3Nov23.shp')
# names(BBBn)
BBB = st_read('/Users/heidi.k.hirsh/Desktop/nutBows_space&time_3Nov23.shp')
...
#I think this is now picking up all the nutrient NAs
...
#Actual latest write out Nov 13
# write.csv(CCmodel.df, file='/Users/heidi.k.hirsh/Desktop/CCmodel_allYears+Nuts_13nov2023.csv')
