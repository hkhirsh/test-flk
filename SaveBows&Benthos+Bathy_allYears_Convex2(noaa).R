...
coral_sf =  st_read(dsn = "/Users/heidihirsh/Desktop/FLK_data/Final_UnifiedReefMap_Version2.0/FWC_UnifiedFloridaReefMap_v2.0.gdb", layer="UnifiedReefMap")
...
year_fl = list.files(path = paste0("/Users/heidihirsh/Desktop/old_bowties_no_land_noAug1"),full.names=T) 
...
bow_fl = list.files(path = paste0("/Users/heidihirsh/Desktop/old_bowties_no_land_noAug1/",Year),full.names=T)
