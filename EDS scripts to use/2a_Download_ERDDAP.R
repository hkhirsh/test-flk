...
EDS_path = "M:/Environmental_Data_Summary/Data_Download/" # PIFSC ARP/CIMAR shared drive
EDS_path = "L:/ktanaka/Environmental_Data_Summary/" # PIFSC Onaga
EDS_path = "/mnt/ldrive/ktanaka/Environmental_Data_Summary/" # PIFSC Onaga
EDS_path = paste0(file.path(dirname(path.expand('~')),'Desktop'), "/Environmental_Data_Summary/") # Local without VPNs
