#model flk!
## 10/9/2023 Model still works! And plots DIC, TA, AragSat for all bow tie durations!
...
#       AIC(m_new,m_new1,sm_new)
      ...
      #I have not included any interaction models yet
      #OR models for different residence times
      ...
      ModAdd=data.frame(
        ...
        ModName=c("BenT0","BenT0.Hr","BenT0.Hr.PAR","BenT0.Hr.PAR.Vol","BenT0.Hr.PAR.Vol.Dep","BenT0.Hr.PAR.Vol.Dep.Mon","BenT0.Hr.PAR.Vol.Dep.Mon.T",
                  "BenT0.Hr.PAR.Vol.Dep.Mon.T.Reg","BenT0.Hr.PAR.Vol.Dep.Mon.T.Dcont","BenT0.Hr.PAR.Vol.Dep.Mon.T.Dcat"),
      ...
      ModAdd$ModName=factor(ModAdd$ModName,levels=c("BenT0","BenT0.Hr","BenT0.Hr.PAR","BenT0.Hr.PAR.Vol","BenT0.Hr.PAR.Vol.Dep","BenT0.Hr.PAR.Vol.Dep.Mon","BenT0.Hr.PAR.Vol.Dep.Mon.T",
                                                    "BenT0.Hr.PAR.Vol.Dep.Mon.T.Reg","BenT0.Hr.PAR.Vol.Dep.Mon.T.Dcont","BenT0.Hr.PAR.Vol.Dep.Mon.T.Dcat"))
      # ModAdd
...
#Volume?
VOL_inclLU=c("NO","NO","NO","YES","YES","YES","YES","YES","YES","YES")
names(VOL_inclLU)=unique(ModCol$ModName)
ModCol$VOL_included=VOL_inclLU[ModCol$ModName]

#Depth?
DEP_inclLU=c("NO","NO","NO","NO","YES","YES","YES","YES","YES","YES")
names(DEP_inclLU)=unique(ModCol$ModName)
ModCol$DEP_included=DEP_inclLU[ModCol$ModName]

#Month?
MON_inclLU=c("NO","NO","NO","NO","NO","YES","YES","YES","YES","YES")
names(MON_inclLU)=unique(ModCol$ModName)
ModCol$MON_included=MON_inclLU[ModCol$ModName]

#Month?
TEMP_inclLU=c("NO","NO","NO","NO","NO","NO","YES","YES","YES","YES")
names(TEMP_inclLU)=unique(ModCol$ModName)
ModCol$TEMP_included=TEMP_inclLU[ModCol$ModName]

#Region Interaction?
REG_inclLU=c("NO","NO","NO","NO","NO","NO","NO","YES","NO","NO")
names(REG_inclLU)=unique(ModCol$ModName)
ModCol$REG_included=REG_inclLU[ModCol$ModName]

#Distance continuous
DCON_inclLU=c("NO","NO","NO","NO","NO","NO","NO","NO","YES","NO")
names(DCON_inclLU)=unique(ModCol$ModName)
ModCol$DCON_included=DCON_inclLU[ModCol$ModName]

#Distance categorical
DCAT_inclLU=c("NO","NO","NO","NO","NO","NO","NO","NO","NO","YES")
names(DCAT_inclLU)=unique(ModCol$ModName)
ModCol$DCAT_included=DCAT_inclLU[ModCol$ModName]
...
iDCON=which(ModCol$DCON_included=="YES")
iDCAT=which(ModCol$DCAT_included=="YES")

ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG="BEN XhrX XparX XvolX XmonX XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[setdiff(setdiff(iHR,iPAR),iVOL)]="BEN HR XparX XvolX XdepX XmonX XtempX XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[setdiff(intersect(iHR,iPAR),iVOL)]="BEN HR PAR XvolX XdepX XmonX XtempX XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iPAR),iVOL)]="BEN HR PAR VOL XdepX XmonX XtempX XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iVOL),iDEP)]="BEN HR PAR VOL DEP XmonX XtempX XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iDEP),iMON)]="BEN HR PAR VOL DEP MON XtempX XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iMON),iTEMP)]="BEN HR PAR VOL DEP MON TEMP XregX"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iTEMP),iREG)]="BEN HR PAR VOL DEP MON TEMP REG"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iTEMP),iDCON)]="BEN HR PAR VOL DEP MON TEMP DCON"
ModCol$HR.PAR.VOL.DEP.MON.TEMP.REG[intersect(intersect(iHR,iTEMP),iDCAT)]="BEN HR PAR VOL DEP MON TEMP DCAT"
...
# sub=subset(ModCol,RTduration=='7_days')
